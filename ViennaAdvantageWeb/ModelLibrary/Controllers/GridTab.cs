...
namespace VAdvantage.Model
{
    public class GridTab : Evaluatee
    {
       ...
       public GridTabVO _vo;
        ...
        //export
        private SortedList<int, int> _exports = null;
        ...
        public GridTab(GridTabVO vo, int curDays)
        {
            _vo = vo;
        ...
        public void LoadExport()
        {
            ...
            try
            {
                if (_exports == null)
                    //create new list for chat
                    _exports = new SortedList<int, int>();
                else
                    //if contain chat then clear list
                    _exports.Clear();
                //execute query
        ...
        public Boolean HasExportRecord()
        {
            ...
            //get chat id
            int key = GetRecord_ID();//ridTable.GetKeyID(CurrentRow);
            return _exports.ContainsKey(key);//return chatId
        }
        public int ExportID()
        {
            if (_exports == null)
        ...
        private String ProcessCallout(GridField field)
        {
            ...
            callout = callout.Replace("org.compiere.model", "VAdvantage.Model");
