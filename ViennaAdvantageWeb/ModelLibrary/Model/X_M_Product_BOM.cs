...
{
public X_M_Product_BOM (Context ctx, int M_Product_BOM_ID, Trx trxName) : base (ctx, M_Product_BOM_ID, trxName)
{
...
public X_M_Product_BOM (Ctx ctx, int M_Product_BOM_ID, Trx trxName) : base (ctx, M_Product_BOM_ID, trxName)
{
/** if (M_Product_BOM_ID == 0)
{
SetBOMQty (0.0);	// 1
...
*/
public X_M_Product_BOM (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Product_BOM (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Product_BOM (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_M_Product_BOM()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27562514380776L;
/** Last Updated Timestamp 7/29/2010 1:07:43 PM */
public static long updatedMS = 1280389063987L;
/** AD_Table_ID=383 */
...
{
StringBuilder sb = new StringBuilder ("X_M_Product_BOM[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set BOM Quantity.
...
public static int BOMTYPE_AD_Reference_ID=279;
/** In alternative Group 1 = 1 */
public static String BOMTYPE_InAlternativeGroup1 = "1";
/** In alternative Group 2 = 2 */
public static String BOMTYPE_InAlternativeGroup2 = "2";
/** In alternaltve Group 3 = 3 */
public static String BOMTYPE_InAlternaltveGroup3 = "3";
/** In alternative Group 4 = 4 */
public static String BOMTYPE_InAlternativeGroup4 = "4";
/** In alternative Group 5 = 5 */
public static String BOMTYPE_InAlternativeGroup5 = "5";
/** In alternative Group 6 = 6 */
public static String BOMTYPE_InAlternativeGroup6 = "6";
/** In alternative Group 7 = 7 */
public static String BOMTYPE_InAlternativeGroup7 = "7";
/** In alternative Group 8 = 8 */
public static String BOMTYPE_InAlternativeGroup8 = "8";
/** In alternative Group 9 = 9 */
public static String BOMTYPE_InAlternativeGroup9 = "9";
/** Optional Part = O */
public static String BOMTYPE_OptionalPart = "O";
/** Standard Part = P */
public static String BOMTYPE_StandardPart = "P";
...
throw new ArgumentException ("BOMType Invalid value - " + BOMType + " - Reference_ID=279 - 1 - 2 - 3 - 4 - 5 - 6 - 7 - 8 - 9 - O - P");
...
{
if (M_ProductBOM_ID < 1) throw new ArgumentException ("M_ProductBOM_ID is mandatory.");
...
{
return new KeyNamePair(Get_ID(), GetM_ProductBOM_ID().ToString());
}
/** Set BOM Line.
@param M_Product_BOM_ID BOM Line */
public void SetM_Product_BOM_ID (int M_Product_BOM_ID)
{
if (M_Product_BOM_ID < 1) throw new ArgumentException ("M_Product_BOM_ID is mandatory.");
Set_ValueNoCheck ("M_Product_BOM_ID", M_Product_BOM_ID);
}
/** Get BOM Line.
@return BOM Line */
public int GetM_Product_BOM_ID() 
{
Object ii = Get_Value("M_Product_BOM_ID");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
/** Set Product.
