...
{
public X_A_Asset (Context ctx, int A_Asset_ID, Trx trxName) : base (ctx, A_Asset_ID, trxName)
{
/** if (A_Asset_ID == 0)
{
...
public X_A_Asset (Ctx ctx, int A_Asset_ID, Trx trxName) : base (ctx, A_Asset_ID, trxName)
{
/** if (A_Asset_ID == 0)
{
SetA_Asset_Group_ID (0);
...
*/
public X_A_Asset (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_A_Asset (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_A_Asset (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
