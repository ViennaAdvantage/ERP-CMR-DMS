...
{
public X_MailAttachment1 (Context ctx, int MailAttachment1_ID, Trx trxName) : base (ctx, MailAttachment1_ID, trxName)
{
...
public X_MailAttachment1 (Ctx ctx, int MailAttachment1_ID, Trx trxName) : base (ctx, MailAttachment1_ID, trxName)
{
/** if (MailAttachment1_ID == 0)
{
SetMailAttachment1_ID (0);
...
*/
public X_MailAttachment1 (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_MailAttachment1 (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_MailAttachment1 (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
