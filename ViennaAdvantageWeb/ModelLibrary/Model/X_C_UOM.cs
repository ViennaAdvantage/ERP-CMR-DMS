...
{
public X_C_UOM (Context ctx, int C_UOM_ID, Trx trxName) : base (ctx, C_UOM_ID, trxName)
{
/** if (C_UOM_ID == 0)
{
SetC_UOM_ID (0);
...
public X_C_UOM (Ctx ctx, int C_UOM_ID, Trx trxName) : base (ctx, C_UOM_ID, trxName)
{
/** if (C_UOM_ID == 0)
{
SetC_UOM_ID (0);
...
*/
public X_C_UOM (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_UOM (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_UOM (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
