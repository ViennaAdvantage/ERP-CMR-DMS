...
public class X_C_DunningRunLine : PO
{
public X_C_DunningRunLine (Context ctx, int C_DunningRunLine_ID, Trx trxName) : base (ctx, C_DunningRunLine_ID, trxName)
{
...
public X_C_DunningRunLine (Ctx ctx, int C_DunningRunLine_ID, Trx trxName) : base (ctx, C_DunningRunLine_ID, trxName)
{
/** if (C_DunningRunLine_ID == 0)
{
SetAmt (0.0);
...
*/
public X_C_DunningRunLine (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_DunningRunLine (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_DunningRunLine (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_C_DunningRunLine()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27562514372062L;
/** Last Updated Timestamp 7/29/2010 1:07:35 PM */
public static long updatedMS = 1280389055273L;
/** AD_Table_ID=524 */
...
{
StringBuilder sb = new StringBuilder ("X_C_DunningRunLine[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Amount.
@param Amt Amount */
...
{
if (C_DunningRunLine_ID < 1) throw new ArgumentException ("C_DunningRunLine_ID is mandatory.");
Set_ValueNoCheck ("C_DunningRunLine_ID", C_DunningRunLine_ID);
}
/** Get Dunning Run Line.
@return Dunning Run Line */
public int GetC_DunningRunLine_ID() 
{
Object ii = Get_Value("C_DunningRunLine_ID");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
/** Set Invoice.
...
{
if (FeeAmt == null) throw new ArgumentException ("FeeAmt is mandatory.");
