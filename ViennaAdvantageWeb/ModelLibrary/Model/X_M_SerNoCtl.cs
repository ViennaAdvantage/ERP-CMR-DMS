...
{
public X_M_SerNoCtl (Context ctx, int M_SerNoCtl_ID, Trx trxName) : base (ctx, M_SerNoCtl_ID, trxName)
{
/** if (M_SerNoCtl_ID == 0)
{
...
public X_M_SerNoCtl (Ctx ctx, int M_SerNoCtl_ID, Trx trxName) : base (ctx, M_SerNoCtl_ID, trxName)
{
/** if (M_SerNoCtl_ID == 0)
{
SetCurrentNext (0);	// 100
...
*/
public X_M_SerNoCtl (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_SerNoCtl (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_SerNoCtl (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
