...
namespace VAdvantage.Model
{
    public class MTaxCategory : X_C_TaxCategory
    {
        ...
        public MTaxCategory(Ctx ctx, int C_TaxCategory_ID, Trx trxName):base(ctx, C_TaxCategory_ID, trxName)
        {
        ...
        /// <param name="trxName">trx</param>
        public MTaxCategory(Ctx ctx, DataRow dr, Trx trxName):base(ctx,dr, trxName)
        {
