...
{
public X_C_Location (Context ctx, int C_Location_ID, Trx trxName) : base (ctx, C_Location_ID, trxName)
{
/** if (C_Location_ID == 0)
{
SetC_Country_ID (0);
...
public X_C_Location (Ctx ctx, int C_Location_ID, Trx trxName) : base (ctx, C_Location_ID, trxName)
{
/** if (C_Location_ID == 0)
{
SetC_Country_ID (0);
...
*/
public X_C_Location (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Location (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Location (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
