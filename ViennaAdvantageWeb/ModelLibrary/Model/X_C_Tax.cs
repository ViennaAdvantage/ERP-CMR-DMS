...
{
public X_C_Tax (Context ctx, int C_Tax_ID, Trx trxName) : base (ctx, C_Tax_ID, trxName)
{
/** if (C_Tax_ID == 0)
{
...
public X_C_Tax (Ctx ctx, int C_Tax_ID, Trx trxName) : base (ctx, C_Tax_ID, trxName)
{
/** if (C_Tax_ID == 0)
{
SetC_TaxCategory_ID (0);
...
*/
public X_C_Tax (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Tax (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Tax (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
