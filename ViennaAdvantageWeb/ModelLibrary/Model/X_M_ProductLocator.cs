...
{
public X_M_ProductLocator (Context ctx, int M_ProductLocator_ID, Trx trxName) : base (ctx, M_ProductLocator_ID, trxName)
{
...
public X_M_ProductLocator (Ctx ctx, int M_ProductLocator_ID, Trx trxName) : base (ctx, M_ProductLocator_ID, trxName)
{
/** if (M_ProductLocator_ID == 0)
{
SetM_Locator_ID (0);
...
*/
public X_M_ProductLocator (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_ProductLocator (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_ProductLocator (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
