...
{
public X_M_InOutLineConfirm (Context ctx, int M_InOutLineConfirm_ID, Trx trxName) : base (ctx, M_InOutLineConfirm_ID, trxName)
{
...
public X_M_InOutLineConfirm (Ctx ctx, int M_InOutLineConfirm_ID, Trx trxName) : base (ctx, M_InOutLineConfirm_ID, trxName)
{
/** if (M_InOutLineConfirm_ID == 0)
{
SetConfirmedQty (0.0);
...
*/
public X_M_InOutLineConfirm (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLineConfirm (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLineConfirm (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
