...
{
public X_M_RequisitionLine (Context ctx, int M_RequisitionLine_ID, Trx trxName) : base (ctx, M_RequisitionLine_ID, trxName)
{
...
public X_M_RequisitionLine (Ctx ctx, int M_RequisitionLine_ID, Trx trxName) : base (ctx, M_RequisitionLine_ID, trxName)
{
/** if (M_RequisitionLine_ID == 0)
{
SetLine (0);	// @SQL=SELECT COALESCE(MAX(Line),0)+10 AS DefaultValue FROM M_RequisitionLine WHERE M_Requisition_ID=@M_Requisition_ID@
...
*/
public X_M_RequisitionLine (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_RequisitionLine (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_RequisitionLine (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
