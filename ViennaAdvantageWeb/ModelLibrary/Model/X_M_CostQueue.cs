...
{
public X_M_CostQueue (Context ctx, int M_CostQueue_ID, Trx trxName) : base (ctx, M_CostQueue_ID, trxName)
{
/** if (M_CostQueue_ID == 0)
{
...
public X_M_CostQueue (Ctx ctx, int M_CostQueue_ID, Trx trxName) : base (ctx, M_CostQueue_ID, trxName)
{
/** if (M_CostQueue_ID == 0)
{
SetC_AcctSchema_ID (0);
...
*/
public X_M_CostQueue (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_CostQueue (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_CostQueue (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
