...
{
public X_C_BankAccount (Context ctx, int C_BankAccount_ID, Trx trxName) : base (ctx, C_BankAccount_ID, trxName)
{
...
public X_C_BankAccount (Ctx ctx, int C_BankAccount_ID, Trx trxName) : base (ctx, C_BankAccount_ID, trxName)
{
/** if (C_BankAccount_ID == 0)
{
SetAccountNo (null);
...
*/
public X_C_BankAccount (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_BankAccount (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_BankAccount (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514370620L;
/** Last Updated Timestamp 7/29/2010 1:07:33 PM */
public static long updatedMS = 1280389053831L;
/** AD_Table_ID=297 */
