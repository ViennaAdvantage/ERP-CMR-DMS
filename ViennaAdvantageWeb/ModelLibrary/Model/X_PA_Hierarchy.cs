...
{
public X_PA_Hierarchy (Context ctx, int PA_Hierarchy_ID, Trx trxName) : base (ctx, PA_Hierarchy_ID, trxName)
{
...
public X_PA_Hierarchy (Ctx ctx, int PA_Hierarchy_ID, Trx trxName) : base (ctx, PA_Hierarchy_ID, trxName)
{
/** if (PA_Hierarchy_ID == 0)
{
SetAD_Tree_Account_ID (0);
...
*/
public X_PA_Hierarchy (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_PA_Hierarchy (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_PA_Hierarchy (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514381873L;
/** Last Updated Timestamp 7/29/2010 1:07:45 PM */
public static long updatedMS = 1280389065084L;
/** AD_Table_ID=821 */
