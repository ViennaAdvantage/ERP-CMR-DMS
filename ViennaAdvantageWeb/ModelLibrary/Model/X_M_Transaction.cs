...
{
public X_M_Transaction (Context ctx, int M_Transaction_ID, Trx trxName) : base (ctx, M_Transaction_ID, trxName) 
{
...
public X_M_Transaction (Ctx ctx, int M_Transaction_ID, Trx trxName) : base (ctx, M_Transaction_ID, trxName)
{
/** if (M_Transaction_ID == 0)
{
SetM_AttributeSetInstance_ID (0);
...
*/
public X_M_Transaction (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Transaction (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Transaction (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
