...
{
public X_C_Recurring (Context ctx, int C_Recurring_ID, Trx trxName) : base (ctx, C_Recurring_ID, trxName)
{
/** if (C_Recurring_ID == 0)
{
SetC_Recurring_ID (0);
...
public X_C_Recurring (Ctx ctx, int C_Recurring_ID, Trx trxName) : base (ctx, C_Recurring_ID, trxName)
{
/** if (C_Recurring_ID == 0)
{
SetC_Recurring_ID (0);
...
*/
public X_C_Recurring (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Recurring (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Recurring (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
