...
namespace VAdvantage.Model
{
    ...
    public class MOrder : X_C_Order, DocAction
    {
         ...
         *	@return Order
         */
        public static MOrder CopyFrom(MOrder from, DateTime? dateDoc, int C_DocTypeTarget_ID, bool counter, bool copyASI, Trx trxName)
        {
        ...
        */
        public int CopyLinesFrom(MOrder otherOrder, bool counter, bool copyASI)
        {
            int count = 0;
            try
            {
        ...
        public String CompleteIt()
        {
            try
            {
                    ...
                    || MDocType.DOCSUBTYPESO_PrepayOrder.Equals(DocSubTypeSO))
                {
                    ...
                    {
                        _processMsg = " Could Not Complete Due To Insufficent Qty, Available Qty Is : " + OnHandQty;
            ...
            try
            {
                ...
                for (int i = 0; i < oLines.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        {
                            _processMsg = "Shipment Could Not Complete";
                        }
                    }
                }
            }
