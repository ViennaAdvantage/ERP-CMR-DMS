...
{
public X_C_Cash (Context ctx, int C_Cash_ID, Trx trxName) : base (ctx, C_Cash_ID, trxName)
{
/** if (C_Cash_ID == 0)
{
...
public X_C_Cash (Ctx ctx, int C_Cash_ID, Trx trxName) : base (ctx, C_Cash_ID, trxName)
{
/** if (C_Cash_ID == 0)
{
SetBeginningBalance (0.0);
...
*/
public X_C_Cash (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Cash (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Cash (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
