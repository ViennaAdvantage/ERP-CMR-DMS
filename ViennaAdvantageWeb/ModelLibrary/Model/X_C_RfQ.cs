...
{
public X_C_RfQ (Context ctx, int C_RfQ_ID, Trx trxName) : base (ctx, C_RfQ_ID, trxName)
{
/** if (C_RfQ_ID == 0)
{
...
public X_C_RfQ (Ctx ctx, int C_RfQ_ID, Trx trxName) : base (ctx, C_RfQ_ID, trxName)
{
/** if (C_RfQ_ID == 0)
{
SetC_Currency_ID (0);	// @$C_Currency_ID @
...
*/
public X_C_RfQ (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_RfQ (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_RfQ (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514374679L;
/** Last Updated Timestamp 7/29/2010 1:07:37 PM */
public static long updatedMS = 1280389057890L;
/** AD_Table_ID=677 */
...
{
StringBuilder sb = new StringBuilder ("X_C_RfQ[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set User/Contact.
...
Set_Value ("C_RfQ_Topic_ID", C_RfQ_Topic_ID);
}
/** Get RfQ Topic.
...
{
if (DateResponse == null) throw new ArgumentException ("DateResponse is mandatory.");
...
{
Set_Value ("IsQuoteAllQty", IsQuoteAllQty);
}
...
{
Set_Value ("IsQuoteTotalAmt", IsQuoteTotalAmt);
}
/** Get Quote Total Amt.
...
{
Set_Value ("IsRfQResponseAccepted", IsRfQResponseAccepted);
}
...
public static int QUOTETYPE_AD_Reference_ID=314;
/** Quote All Lines = A */
public static String QUOTETYPE_QuoteAllLines = "A";
/** Quote Selected Lines = S */
public static String QUOTETYPE_QuoteSelectedLines = "S";
/** Quote Total only = T */
public static String QUOTETYPE_QuoteTotalOnly = "T";
/** Is test a valid value.
@param test testvalue
@returns true if valid **/
public bool IsQuoteTypeValid (String test)
{
return test.Equals("A") || test.Equals("S") || test.Equals("T");
}
/** Set RfQ Type.
@param QuoteType Request for Quotation Type */
public void SetQuoteType (String QuoteType)
{
if (QuoteType == null) throw new ArgumentException ("QuoteType is mandatory");
if (!IsQuoteTypeValid(QuoteType))
throw new ArgumentException ("QuoteType Invalid value - " + QuoteType + " - Reference_ID=314 - A - S - T");
