...
{
public X_C_PaySelectionCheck (Context ctx, int C_PaySelectionCheck_ID, Trx trxName) : base (ctx, C_PaySelectionCheck_ID, trxName)
{
...
public X_C_PaySelectionCheck (Ctx ctx, int C_PaySelectionCheck_ID, Trx trxName) : base (ctx, C_PaySelectionCheck_ID, trxName)
{
/** if (C_PaySelectionCheck_ID == 0)
{
SetC_BPartner_ID (0);
...
*/
public X_C_PaySelectionCheck (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySelectionCheck (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySelectionCheck (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
