...
{
public X_C_PaySelectionLine (Context ctx, int C_PaySelectionLine_ID, Trx trxName) : base (ctx, C_PaySelectionLine_ID, trxName)
{
...
public X_C_PaySelectionLine (Ctx ctx, int C_PaySelectionLine_ID, Trx trxName) : base (ctx, C_PaySelectionLine_ID, trxName)
{
/** if (C_PaySelectionLine_ID == 0)
{
SetC_Invoice_ID (0);
...
*/
public X_C_PaySelectionLine (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySelectionLine (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySelectionLine (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
