...
{
public X_M_InOutLine (Context ctx, int M_InOutLine_ID, Trx trxName) : base (ctx, M_InOutLine_ID, trxName)
{
/** if (M_InOutLine_ID == 0)
{
...
public X_M_InOutLine (Ctx ctx, int M_InOutLine_ID, Trx trxName) : base (ctx, M_InOutLine_ID, trxName)
{
/** if (M_InOutLine_ID == 0)
{
SetC_UOM_ID (0);	// @#C_UOM_ID@
...
*/
public X_M_InOutLine (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLine (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLine (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
