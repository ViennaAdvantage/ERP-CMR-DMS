...
{
public X_M_AttributeSet (Context ctx, int M_AttributeSet_ID, Trx trxName) : base (ctx, M_AttributeSet_ID, trxName)
{
...
public X_M_AttributeSet (Ctx ctx, int M_AttributeSet_ID, Trx trxName) : base (ctx, M_AttributeSet_ID, trxName)
{
/** if (M_AttributeSet_ID == 0)
{
SetIsGuaranteeDate (false);
...
*/
public X_M_AttributeSet (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_AttributeSet (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_AttributeSet (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
