...
using System.Data;
/** Generated Model for C_ProfitLossLines
 *  @author Jagmohan Bhatt (generated) 
 *  @version Vienna Framework 1.1.1 - $Id$ */
public class X_C_ProfitLossLines : PO
{
public X_C_ProfitLossLines (Context ctx, int C_ProfitLossLines_ID, Trx trxName) : base (ctx, C_ProfitLossLines_ID, trxName)
{
/** if (C_ProfitLossLines_ID == 0)
{
SetC_AcctSchema_ID (0);
SetC_ProfitLossLines_ID (0);
SetC_ProfitLoss_ID (0);
SetPostingType (null);
}
 */
}
public X_C_ProfitLossLines (Ctx ctx, int C_ProfitLossLines_ID, Trx trxName) : base (ctx, C_ProfitLossLines_ID, trxName)
{
/** if (C_ProfitLossLines_ID == 0)
{
SetC_AcctSchema_ID (0);
...
*/
public X_C_ProfitLossLines (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ProfitLossLines (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ProfitLossLines (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_C_ProfitLossLines()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27681650402165L;
/** Last Updated Timestamp 5/8/2014 10:28:05 AM */
public static long updatedMS = 1399525085376L;
/** AD_Table_ID=1000440 */
...
{
StringBuilder sb = new StringBuilder ("X_C_ProfitLossLines[").Append(Get_ID()).Append("]");
return sb.ToString();
}
...
public void SetAccountCredit (Decimal? AccountCredit)
{
Set_Value ("AccountCredit", (Decimal?)AccountCredit);
}
/** Get Account Credit.
@return Account Credit */
public Decimal GetAccountCredit() 
{
Object bd =Get_Value("AccountCredit");
...
public Decimal GetAccountDebit() 
{
Object bd =Get_Value("AccountDebit");
if (bd == null) return Env.ZERO;
return  Convert.ToDecimal(bd);
}
...
/** Set Profit Loss Line.
@param C_ProfitLossLines_ID Profit Loss Line */
public void SetC_ProfitLossLines_ID (int C_ProfitLossLines_ID)
{
if (C_ProfitLossLines_ID < 1) throw new ArgumentException ("C_ProfitLossLines_ID is mandatory.");
Set_ValueNoCheck ("C_ProfitLossLines_ID", C_ProfitLossLines_ID);
}
/** Get Profit Loss Line.
@return Profit Loss Line */
public int GetC_ProfitLossLines_ID() 
{
Object ii = Get_Value("C_ProfitLossLines_ID");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
/** Set Profit Loss.
...
{
if (LedgerCode != null && LedgerCode.Length > 20)
{
log.Warning("Length > 20 - truncated");
LedgerCode = LedgerCode.Substring(0,20);
}
...
public void SetSourceCredit (Decimal? SourceCredit)
{
Set_Value ("SourceCredit", (Decimal?)SourceCredit);
}
/** Get Source Credit.
@return Source Credit */
public Decimal GetSourceCredit() 
{
Object bd =Get_Value("SourceCredit");
if (bd == null) return Env.ZERO;
return  Convert.ToDecimal(bd);
}
/** Set Source Debit.
...
/** Get Source Debit.
@return Source Debit */
public Decimal GetSourceDebit() 
{
Object bd =Get_Value("SourceDebit");
if (bd == null) return Env.ZERO;
return  Convert.ToDecimal(bd);
}
