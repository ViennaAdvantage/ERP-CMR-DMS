...
{
public X_A_Asset_Group (Context ctx, int A_Asset_Group_ID, Trx trxName) : base (ctx, A_Asset_Group_ID, trxName)
{
...
public X_A_Asset_Group (Ctx ctx, int A_Asset_Group_ID, Trx trxName) : base (ctx, A_Asset_Group_ID, trxName)
{
/** if (A_Asset_Group_ID == 0)
{
SetA_Asset_Group_ID (0);
...
*/
public X_A_Asset_Group (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_A_Asset_Group (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_A_Asset_Group (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
