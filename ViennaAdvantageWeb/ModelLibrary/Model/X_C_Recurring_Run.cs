...
{
public X_C_Recurring_Run (Context ctx, int C_Recurring_Run_ID, Trx trxName) : base (ctx, C_Recurring_Run_ID, trxName)
{
...
public X_C_Recurring_Run (Ctx ctx, int C_Recurring_Run_ID, Trx trxName) : base (ctx, C_Recurring_Run_ID, trxName)
{
/** if (C_Recurring_Run_ID == 0)
{
SetC_Recurring_ID (0);
...
*/
public X_C_Recurring_Run (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Recurring_Run (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Recurring_Run (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_C_Recurring_Run()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27562514374491L;
/** Last Updated Timestamp 7/29/2010 1:07:37 PM */
public static long updatedMS = 1280389057702L;
/** AD_Table_ID=573 */
...
{
StringBuilder sb = new StringBuilder ("X_C_Recurring_Run[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Invoice.
...
{
if (C_Recurring_Run_ID < 1) throw new ArgumentException ("C_Recurring_Run_ID is mandatory.");
Set_ValueNoCheck ("C_Recurring_Run_ID", C_Recurring_Run_ID);
}
/** Get Recurring Run.
@return Recurring Document Run */
public int GetC_Recurring_Run_ID() 
{
Object ii = Get_Value("C_Recurring_Run_ID");
if (ii == null) return 0;
return Convert.ToInt32(ii);
}
/** Set Document Date.
