namespace VAdvantage.Model
{
    ...
    {
        public X_Fact_Accumulation(Context ctx, int Fact_Accumulation_ID, Trx trxName)
        ...
        public X_Fact_Accumulation(Ctx ctx, int Fact_Accumulation_ID, Trx trxName)
            : base(ctx, Fact_Accumulation_ID, trxName)
        {
            /** if (Fact_Accumulation_ID == 0)
            {
        ...
        */
        public X_Fact_Accumulation(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_Fact_Accumulation(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_Fact_Accumulation(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
        ...
        /** Serial Version No */
        //static long serialVersionUID 27669380150086L;
        /** Last Updated Timestamp 12/17/2013 10:03:53 AM */
        public static long updatedMS = 1387254833297L;
        /** AD_Table_ID=1000178 */
        ...
        */
        ...
        {
            return test == null || test.Equals("D") || test.Equals("M") || test.Equals("P") || test.Equals("W");
        }
        /** Set BALANCEACCUMULATION.
        ...
        public void SetBALANCEACCUMULATION(String BALANCEACCUMULATION)
        {
            if (!IsBALANCEACCUMULATIONValid(BALANCEACCUMULATION))
                throw new ArgumentException("BALANCEACCUMULATION Invalid value - " + BALANCEACCUMULATION + " - Reference_ID=1000073 - D - M - P - W");
            if (BALANCEACCUMULATION != null && BALANCEACCUMULATION.Length > 1)
            {
