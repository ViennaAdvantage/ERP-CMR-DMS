...
{
public X_M_InOutLineMA (Context ctx, int M_InOutLineMA_ID, Trx trxName) : base (ctx, M_InOutLineMA_ID, trxName)
{
...
public X_M_InOutLineMA (Ctx ctx, int M_InOutLineMA_ID, Trx trxName) : base (ctx, M_InOutLineMA_ID, trxName)
{
/** if (M_InOutLineMA_ID == 0)
{
SetM_AttributeSetInstance_ID (0);
...
*/
public X_M_InOutLineMA (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLineMA (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOutLineMA (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
