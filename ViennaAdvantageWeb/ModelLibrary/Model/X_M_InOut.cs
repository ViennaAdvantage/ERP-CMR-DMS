...
{
public X_M_InOut (Context ctx, int M_InOut_ID, Trx trxName) : base (ctx, M_InOut_ID, trxName)
{
/** if (M_InOut_ID == 0)
{
SetC_BPartner_ID (0);
...
public X_M_InOut (Ctx ctx, int M_InOut_ID, Trx trxName) : base (ctx, M_InOut_ID, trxName)
{
/** if (M_InOut_ID == 0)
{
SetC_BPartner_ID (0);
...
*/
public X_M_InOut (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOut (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_InOut (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
