...
{
public X_C_PaySchedule (Context ctx, int C_PaySchedule_ID, Trx trxName) : base (ctx, C_PaySchedule_ID, trxName)
{
...
public X_C_PaySchedule (Ctx ctx, int C_PaySchedule_ID, Trx trxName) : base (ctx, C_PaySchedule_ID, trxName)
{
/** if (C_PaySchedule_ID == 0)
{
SetC_PaySchedule_ID (0);
...
*/
public X_C_PaySchedule (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySchedule (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_PaySchedule (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
 Set Table ID By Table Name
 added by ->Harwinder */
static X_C_PaySchedule()
{
 Table_ID = Get_Table_ID(Table_Name);
 model = new KeyNamePair(Table_ID,Table_Name);
}
/** Serial Version No */
//static long serialVersionUID 27562514373551L;
/** Last Updated Timestamp 7/29/2010 1:07:36 PM */
public static long updatedMS = 1280389056762L;
/** AD_Table_ID=548 */
