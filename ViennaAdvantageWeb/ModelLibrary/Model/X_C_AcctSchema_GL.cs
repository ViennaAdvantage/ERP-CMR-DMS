...
{
public X_C_AcctSchema_GL (Context ctx, int C_AcctSchema_GL_ID, Trx trxName) : base (ctx, C_AcctSchema_GL_ID, trxName)
{
...
public X_C_AcctSchema_GL (Ctx ctx, int C_AcctSchema_GL_ID, Trx trxName) : base (ctx, C_AcctSchema_GL_ID, trxName)
{
/** if (C_AcctSchema_GL_ID == 0)
{
SetC_AcctSchema_ID (0);
...
*/
public X_C_AcctSchema_GL (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_AcctSchema_GL (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_AcctSchema_GL (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
