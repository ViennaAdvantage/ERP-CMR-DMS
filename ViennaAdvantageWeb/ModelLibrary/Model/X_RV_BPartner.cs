...
{
public X_RV_BPartner (Context ctx, int RV_BPartner_ID, Trx trxName) : base (ctx, RV_BPartner_ID, trxName)
{
/** if (RV_BPartner_ID == 0)
{
SetAD_User_ID (0);
...
public X_RV_BPartner (Ctx ctx, int RV_BPartner_ID, Trx trxName) : base (ctx, RV_BPartner_ID, trxName)
{
/** if (RV_BPartner_ID == 0)
{
SetAD_User_ID (0);
...
*/
public X_RV_BPartner (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_RV_BPartner (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_RV_BPartner (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
