...
*/
public X_C_AllocationHdr (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_AllocationHdr (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_AllocationHdr (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514369805L;
/** Last Updated Timestamp 7/29/2010 1:07:33 PM */
public static long updatedMS = 1280389053016L;
/** AD_Table_ID=735 */
...
{
StringBuilder sb = new StringBuilder ("X_C_AllocationHdr[").Append(Get_ID()).Append("]");
return sb.ToString();
}
/** Set Approval Amount.
...
{
if (ApprovalAmt == null) throw new ArgumentException ("ApprovalAmt is mandatory.");
