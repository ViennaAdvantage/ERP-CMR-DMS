...
{
public X_PA_Report (Context ctx, int PA_Report_ID, Trx trxName) : base (ctx, PA_Report_ID, trxName)
{
/** if (PA_Report_ID == 0)
{
...
public X_PA_Report (Ctx ctx, int PA_Report_ID, Trx trxName) : base (ctx, PA_Report_ID, trxName)
{
/** if (PA_Report_ID == 0)
{
SetC_AcctSchema_ID (0);
...
*/
public X_PA_Report (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_PA_Report (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_PA_Report (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
/** Serial Version No */
//static long serialVersionUID 27562514382061L;
/** Last Updated Timestamp 7/29/2010 1:07:45 PM */
public static long updatedMS = 1280389065272L;
/** AD_Table_ID=445 */
