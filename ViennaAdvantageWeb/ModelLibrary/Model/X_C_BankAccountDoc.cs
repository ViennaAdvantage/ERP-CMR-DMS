...
{
public X_C_BankAccountDoc (Context ctx, int C_BankAccountDoc_ID, Trx trxName) : base (ctx, C_BankAccountDoc_ID, trxName)
{
...
public X_C_BankAccountDoc (Ctx ctx, int C_BankAccountDoc_ID, Trx trxName) : base (ctx, C_BankAccountDoc_ID, trxName)
{
/** if (C_BankAccountDoc_ID == 0)
{
SetC_BankAccountDoc_ID (0);
...
*/
public X_C_BankAccountDoc (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_BankAccountDoc (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_BankAccountDoc (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
