...
{
public X_C_Project (Context ctx, int C_Project_ID, Trx trxName) : base (ctx, C_Project_ID, trxName)
{
/** if (C_Project_ID == 0)
{
SetC_Project_ID (0);
...
public X_C_Project (Ctx ctx, int C_Project_ID, Trx trxName) : base (ctx, C_Project_ID, trxName)
{
/** if (C_Project_ID == 0)
{
SetC_Project_ID (0);
...
*/
public X_C_Project (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Project (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Project (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
