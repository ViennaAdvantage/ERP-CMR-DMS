...
{
public X_M_Movement (Context ctx, int M_Movement_ID, Trx trxName) : base (ctx, M_Movement_ID, trxName)
{
/** if (M_Movement_ID == 0)
{
SetC_DocType_ID (0);
...
public X_M_Movement (Ctx ctx, int M_Movement_ID, Trx trxName) : base (ctx, M_Movement_ID, trxName)
{
/** if (M_Movement_ID == 0)
{
SetC_DocType_ID (0);
...
*/
public X_M_Movement (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Movement (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_M_Movement (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
