...
{
return test.Equals("B") || test.Equals("F") || test.Equals("P") || test.Equals("S");
}
/** Set Discount Type.
...
throw new ArgumentException ("DiscountType Invalid value - " + DiscountType + " - Reference_ID=247 - B - F - P - S");
