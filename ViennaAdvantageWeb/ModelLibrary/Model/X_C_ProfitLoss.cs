...
{
public X_C_ProfitLoss (Context ctx, int C_ProfitLoss_ID, Trx trxName) : base (ctx, C_ProfitLoss_ID, trxName)
{
...
public X_C_ProfitLoss (Ctx ctx, int C_ProfitLoss_ID, Trx trxName) : base (ctx, C_ProfitLoss_ID, trxName)
{
/** if (C_ProfitLoss_ID == 0)
{
SetC_ProfitLoss_ID (0);
...
*/
public X_C_ProfitLoss (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ProfitLoss (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ProfitLoss (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
