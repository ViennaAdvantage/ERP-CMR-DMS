...
{
public X_I_Invoice (Context ctx, int I_Invoice_ID, Trx trxName) : base (ctx, I_Invoice_ID, trxName)
{
/** if (I_Invoice_ID == 0)
{
SetI_Invoice_ID (0);
...
public X_I_Invoice (Ctx ctx, int I_Invoice_ID, Trx trxName) : base (ctx, I_Invoice_ID, trxName)
{
/** if (I_Invoice_ID == 0)
{
SetI_Invoice_ID (0);
...
*/
public X_I_Invoice (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_Invoice (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_I_Invoice (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
