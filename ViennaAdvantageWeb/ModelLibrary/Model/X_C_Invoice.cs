...
{
public X_C_Invoice (Context ctx, int C_Invoice_ID, Trx trxName) : base (ctx, C_Invoice_ID, trxName)
{
/** if (C_Invoice_ID == 0)
{
SetC_BPartner_ID (0);
...
public X_C_Invoice (Ctx ctx, int C_Invoice_ID, Trx trxName) : base (ctx, C_Invoice_ID, trxName)
{
/** if (C_Invoice_ID == 0)
{
SetC_BPartner_ID (0);
...
*/
public X_C_Invoice (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Invoice (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Invoice (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
