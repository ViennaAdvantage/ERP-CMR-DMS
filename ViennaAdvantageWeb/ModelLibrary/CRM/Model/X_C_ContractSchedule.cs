...
{
public X_C_ContractSchedule (Context ctx, int C_ContractSchedule_ID, Trx trxName) : base (ctx, C_ContractSchedule_ID, trxName)
{
...
public X_C_ContractSchedule (Ctx ctx, int C_ContractSchedule_ID, Trx trxName) : base (ctx, C_ContractSchedule_ID, trxName)
{
/** if (C_ContractSchedule_ID == 0)
{
SetC_ContractSchedule_ID (0);
...
*/
public X_C_ContractSchedule (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ContractSchedule (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_ContractSchedule (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
