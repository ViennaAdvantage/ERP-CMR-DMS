...
{
public X_C_Contract (Context ctx, int C_Contract_ID, Trx trxName) : base (ctx, C_Contract_ID, trxName)
{
/** if (C_Contract_ID == 0)
{
SetC_BPartner_ID (0);
...
public X_C_Contract (Ctx ctx, int C_Contract_ID, Trx trxName) : base (ctx, C_Contract_ID, trxName)
{
/** if (C_Contract_ID == 0)
{
SetC_BPartner_ID (0);
...
*/
public X_C_Contract (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Contract (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_C_Contract (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
