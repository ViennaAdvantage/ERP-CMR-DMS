    ...
    public class MergeProcess : ProcessEngine.SvrProcess
    {
        ...
        protected override String DoIt()
        {
            ...
            try
            {
                ...
                idr = DataBase.DB.ExecuteReader(fromSql, param, null);
            ...
            try
            {
                ...
                idr = DataBase.DB.ExecuteReader(toSql, param, null);
                while (idr.Read())
                {
            ...
            try
            {
                ...
                if (success)
                {
                    ...
                    try
                    {
                        ...
                        //count = DataBase.DB.ExecuteQuery(sql, null, null);
        ...
        private void PostMerge(String ColumnName, int to_ID)
        {
            ...
            {
                MBPartner bp = new MBPartner(GetCtx(), to_ID, null);
                if (bp.Get_ID() != 0)
                {
