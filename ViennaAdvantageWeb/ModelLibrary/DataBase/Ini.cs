...
//#pragma warning restore 612, 618
        ...
        public static void SetProperty(string key, string value)
        {
            ...
            else
            {
                ...
                {
                    String eValue = SecureEngineUtility.SecureEngine.Encrypt(value);
                    if (eValue == null)
                        s_prop.SetProperty(key, "");
                    else
        ...
        public static string GetProperty(string key)
        {
            ...
            if (retStr.Substring(0, 3) == "xyz")
                ...
                value = SecureEngineUtility.SecureEngine.Decrypt(retStr);
            //	log.finer(key + "=" + value);
            if (value == null)
                return "";
            return value;
        ...
        private static String CheckProperty(String key, String defaultValue)
        {
            ...
            if (key.Equals(P_WARNING))
                ...
                result = s_prop.GetProperty(key, SecureEngineUtility.SecureEngine.Encrypt(defaultValue));
