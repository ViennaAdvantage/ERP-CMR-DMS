...
namespace VAdvantage.Model
{
        ...
        */
        ...
        private Object Encrypt(int index, Object xx)
        {
            ...
            if (index != -1 && p_info.IsEncrypted(index))
                return SecureEngineUtility.SecureEngine.Encrypt(xx);
            return xx;
        }
	 ...
	 */
        private Object Decrypt(int index, Object yy)
        {
            ...
            if (index != -1 && p_info.IsEncrypted(index))
            {
                if (yy is String && SecureEngineUtility.SecureEngine.IsEncrypted((string)yy))
                {
                    return SecureEngineUtility.SecureEngine.Decrypt(yy);
                }
            }
            return yy;
        }	//
     ...
     */
        ...
        */
        ...
        ///  ///  /// <writer>Raghu</writer>
        /// <Date>03-March-2011</Date>
        private VAdvantage.Utility.Env.QueryParams GetSaveNewQueryInfo()
        {
            ...
            //
            return new VAdvantage.Utility.Env.QueryParams(sqlInsert.ToString(), paramst.ToArray());
        }
        ...
        protected VAdvantage.Utility.Env.QueryParams GetSaveUpdateQueryInfo()
        {
            //
