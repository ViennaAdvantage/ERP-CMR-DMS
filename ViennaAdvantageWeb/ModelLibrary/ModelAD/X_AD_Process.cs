...
{
public X_AD_Process (Context ctx, int AD_Process_ID, Trx trxName) : base (ctx, AD_Process_ID, trxName)
{
/** if (AD_Process_ID == 0)
{
SetAD_Process_ID (0);
...
public X_AD_Process (Ctx ctx, int AD_Process_ID, Trx trxName) : base (ctx, AD_Process_ID, trxName)
{
/** if (AD_Process_ID == 0)
{
SetAD_Process_ID (0);
...
*/
public X_AD_Process (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_Process (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_Process (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
