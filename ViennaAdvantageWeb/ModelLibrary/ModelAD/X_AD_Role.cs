...
{
public X_AD_Role (Context ctx, int AD_Role_ID, Trx trxName) : base (ctx, AD_Role_ID, trxName)
{
/** if (AD_Role_ID == 0)
{
SetAD_Role_ID (0);
...
public X_AD_Role (Ctx ctx, int AD_Role_ID, Trx trxName) : base (ctx, AD_Role_ID, trxName)
{
/** if (AD_Role_ID == 0)
{
SetAD_Role_ID (0);
...
*/
public X_AD_Role (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_Role (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_Role (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
