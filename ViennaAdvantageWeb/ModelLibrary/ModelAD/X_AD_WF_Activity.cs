...
{
public X_AD_WF_Activity (Context ctx, int AD_WF_Activity_ID, Trx trxName) : base (ctx, AD_WF_Activity_ID, trxName)
{
...
public X_AD_WF_Activity (Ctx ctx, int AD_WF_Activity_ID, Trx trxName) : base (ctx, AD_WF_Activity_ID, trxName)
{
/** if (AD_WF_Activity_ID == 0)
{
SetAD_Table_ID (0);
...
*/
public X_AD_WF_Activity (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_WF_Activity (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_WF_Activity (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
...
{
return test.Equals("CA") || test.Equals("CC") || test.Equals("CT") || test.Equals("ON") || test.Equals("OR") || test.Equals("OS");
}
/** Set Workflow State.
...
throw new ArgumentException ("WFState Invalid value - " + WFState + " - Reference_ID=305 - CA - CC - CT - ON - OR - OS");
if (WFState.Length > 2)
{
