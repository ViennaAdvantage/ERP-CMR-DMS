...
namespace VAdvantage.Model
{
   ...
   public static MIssue Create(LogRecord record)
	...
	public static MIssue Create(Ctx ctx, String hexInput)
	{
		...
		{
			byte[] byteArray =  SecureEngineUtility.Secure.ConvertHexString(hexInput);
	...
	public String Report()
	{
        ...
        //       ms.Flush();
        //       // oOut.flush();
        //       // String hexString = SecureEngineUtility.Secure.ConvertToHexString(bOut.toByteArray());
        //       String hexString = SecureEngineUtility.Secure.ConvertToHexString(ms.ToArray());
