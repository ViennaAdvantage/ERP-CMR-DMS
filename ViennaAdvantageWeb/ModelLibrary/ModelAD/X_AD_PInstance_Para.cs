...
{
public X_AD_PInstance_Para (Context ctx, int AD_PInstance_Para_ID, Trx trxName) : base (ctx, AD_PInstance_Para_ID, trxName)
{
...
public X_AD_PInstance_Para (Ctx ctx, int AD_PInstance_Para_ID, Trx trxName) : base (ctx, AD_PInstance_Para_ID, trxName)
{
/** if (AD_PInstance_Para_ID == 0)
{
SetAD_PInstance_ID (0);
...
*/
public X_AD_PInstance_Para (Context ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_PInstance_Para (Ctx ctx, DataRow rs, Trx trxName) : base(ctx, rs, trxName)
{
}
/** Load Constructor 
@param ctx context
...
@param trxName transaction
*/
public X_AD_PInstance_Para (Ctx ctx, IDataReader dr, Trx trxName) : base(ctx, dr, trxName)
{
}
/** Static Constructor 
