    ...
    public class MDocBaseType : X_C_DocBaseType
    {
        ...
        public new String GetAccountingClassname()
        {
            ...
            if (className != null && className.Length > 0)
            {
                /**************Manfacturing*******************/
                //Jun,06,2011/
                if (className.Contains("cmfg"))
                {
                    className = className.Replace("org.compiere.cmfg.acct", "ViennaAdvantage.CMFG.Acct");
                }
                if (className.Contains("cwms"))
                {
                    className = className.Replace("org.compiere.cwms.acct", "ViennaAdvantage.CWMS.Acct");
                }
                if (className.Contains("cmrp"))
                {
                    className = className.Replace("org.compiere.cmrp.acct", "ViennaAdvantage.CMRP.Acct");
                }
                /**************Manfacturing*******************/
                //Jun,06,2011/
                return className;
