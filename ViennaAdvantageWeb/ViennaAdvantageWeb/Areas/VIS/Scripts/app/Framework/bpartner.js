...
; (function (VIS, $) {
  ...
  + "</table>");
    ...
    function HtmlTable(windowNo, BPartnerID, BPtype, dd, greeting, bpgroup, bplocation, bprelation) {
        ...
        var $bpartnerroot = $("<table id='tableBPartner_" + windowNo + "'> <tr> <td ><div style='margin-top: 0px;width:125px' class='wsp-BPartner'>" + VIS.Msg.getMsg("BPType") + "</div></td><td  colspan='4' ><div style='float:left;margin-right: 15px;margin-bottom: 2px;border: 1px solid #bdbdbd;width:98%;height: 35px;margin-left: 5px;'> <div style='float:left;margin-left:138px;margin-top: 5px;'> <input id='chkCustomer_" + windowNo + "' type='checkbox'> " + VIS.Msg.getMsg("Customer") + "</div> <div style='float:left;margin-left: 200px;margin-top: 5px;'>  <input id='chkVendor_" + windowNo + "' type='checkbox'>  " + VIS.Msg.getMsg("Vendor") + " </div>  </div></td>  </tr>" +
...
+ "</table>");
    ...
    function OpenDialogPopup(root, windowNo, BPartnerID, BPtype) {
        ...
        addBPartnerDialog.setHeight(420);
        //addBPartnerDialog.setHeight(h);
        if (BPtype == "") {
            addBPartnerDialog.setTitle(VIS.Msg.getMsg("Customer"));
        }
            //else if (BPtype == "Customer") {
            //    addBPartnerDialog.setTitle(VIS.Msg.getMsg("Customer"));
            //}
            ...
            addBPartnerDialog.setTitle(BPtype);
        }
        addBPartnerDialog.setEnableResize(false);
        addBPartnerDialog.setModal(true);
    ...
    function SaveBPartner(windowNo, category, BPartnerID) {
        addBPartnerDialog.onOkClick = function (e) {
            ...
            if ($chkCustomer.is(":checked") == false && $chkVendor.is(":checked") == false) {
            ...
            window.setTimeout(function () {
                $.ajax({
                    ...
                    data: {
                        ...
                        //phoneNo2: txtPhone2,
                        //fax: txtFax,
                        //windowNo: windowNo, BPtype: BPtype
                        C_BPartner_ID: BPartnerID,
                        searchKey: searchKey,
                        name: name,
                        name2: name2,
                        ...
                        phoneNo2: phone2,
                        fax: fax,
                        windowNo: windowNo, BPtype: BPtype, isCustomer: isCustomer, isVendor: isVendor
