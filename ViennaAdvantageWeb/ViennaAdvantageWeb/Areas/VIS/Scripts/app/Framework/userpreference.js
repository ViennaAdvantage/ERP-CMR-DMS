    ...
    function UserPreference(isGmailSettings) {
        ...
        this.init = function (root) {
           ...
           // $chkContactIsSyncBackground = root.find("#chkContactIsSyncBackground_" + windowNo);
            ...
            $printnative.prop("checked", VIS.Ini.getLocalStorage(VIS.IniConstants.P_Print_Native_Digits) == "N" ? false : true);
            $cachewindows.prop("checked", VIS.Ini.getLocalStorage(VIS.IniConstants.P_CACHE_WINDOW) == "N" ? false : true);
            ...
            $tracefile.prop("checked", VIS.Ini.getLocalStorage(VIS.IniConstants.P_TRACEFILE) == "N" ? false : true);
            ...
            $btnSaveChangePassword.on("click", function () {
                ...
                if ((currentPws.length <= 0 && newPws.length <= 0 && conformPws.length <= 0) || (currentPws.length > 0 && newPws.length > 0 && conformPws.length > 0)) {
                    ...
                    lblChangePasswordMessage.text(VIS.Msg.getMsg("mandatoryFields"));
                    return;
                }

                //match confirm password
                if (newPws != conformPws) {
                    lblChangePasswordMessage.css('color', 'red');
