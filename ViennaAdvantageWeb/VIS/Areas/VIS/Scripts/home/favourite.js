; (function (VIS, $) {
    ...
    function favMgr() {
        ...
        function addFavourite(barNode) {
            ...
            var btnZoom = $("<a data-id='" + id + "' data-action='" + barNode.Action + "' data-btn='zoom' style='height: 25px;width: 25px;float: right;margin-top: -17px;margin-right: -10px;'>").append($("<img data-id='" + id + "' data-action='" + barNode.Action + "' data-btn='zoom' src='" + VIS.Application.contextUrl + "Areas/VIS/Images/zoomfav.png' >"));
            //btnZoom.on('click', function (e) {

            //});
            li.append(btnZoom);

            var btnRemove = $("<a data-id='" + barNode.NodeID + "'  data-btn='remove' style='height: 25px;width: 25px;float: right;margin-top: -16px;'>").append($("<img data-id='" + barNode.NodeID + "'  data-btn='remove' src='" + VIS.Application.contextUrl + "Areas/VIS/Images/removefav.png' >"));
            li.append(btnRemove);
