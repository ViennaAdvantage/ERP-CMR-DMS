    ...
    function VPaySelect() {
        ...
        function customDesign() {
            ...
            var designPSelectInfo = " <div class='vis-pSelectInfo'>"  // div pSelectInfo starts here
                             ...
                             + " <input type='number' id='VIS_txtPaymentAmount_" + $self.windowNo + "' MaxLength='50'></input>"
        ...
        function loadGrid()
        {
            ...
            dGrid.on('select', function (event) {
                paymentAmount += VIS.Utility.Util.getValueOfInt(rows[event.index].PAYMENTAMOUNT);
