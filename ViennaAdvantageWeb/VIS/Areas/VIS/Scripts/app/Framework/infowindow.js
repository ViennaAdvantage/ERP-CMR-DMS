...

                    {
                        ...
                        if (srchCtrls[i].AD_Reference_ID == VIS.DisplayType.String
                            ...
                            if (srchCtrls[i].IsRange) {
                                ...
                                whereClause += " ( " + srchCtrls[i].ColumnName + " BETWEEN " + fromValue + " AND " + toValue + ")";
                            }
                            else {
                                whereClause += srchCtrls[i].ColumnName + " =" + fromValue;
                            }
                        }
                            ...
                            whereClause += srchCtrls[i].ColumnName + " = '" + srchValue + "'";
