        ...
        this.show = function () {
            ...
            for (var c = 0; c < ds.tables[0].columns.length; c++) {
                ...
                if (ds.tables[0].columns[c].name == "name") {
                    columns.push({ field: ds.tables[0].columns[c].name, caption: VIS.Msg.getMsg("Name"), size: '150px', hidden: false });
                }
                    ...
                    columns.push({ field: ds.tables[0].columns[c].name, caption: VIS.Msg.getMsg("Mailtext"), size: '150px', hidden: false });
                }
                else if (ds.tables[0].columns[c].name == "created") {
                    columns.push({ field: ds.tables[0].columns[c].name, caption: VIS.Msg.getMsg("Created"), size: '150px', hidden: false });
                }
                else if (ds.tables[0].columns[c].name == "isdynamiccontent") {
                    columns.push({ field: ds.tables[0].columns[c].name, caption: VIS.Msg.getMsg("IsDynamicContent"), size: '150px', hidden: false });
                }
                else {
