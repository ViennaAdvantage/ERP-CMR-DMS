...
; (function (VIS, $) {
    ...
    function VSetup() {
       ...
       // $root.height($(window).height() - 70);
        ...
        var divRight = $("<div style='background-color: rgb(241, 241, 241);width:20%;height:100%;padding:15px;' class='vis-pull-right' >");
        ...
        this.load = function () {
           ...
           // var dRbtns = $("<div class='initial-btn-right'>");
            ...
            chkDA = $('<input type="checkbox" style="margin-right: 5px;margin-left: 10px;margin-top: 5px;">');
            ...
            lblDA=$("<label style='margin-right: 10px;font-size: 14px;color: #666;font-weight: normal;'>").append(VIS.Msg.getMsg("UseDefault"));
           ...
           // dRbtns.append(btnLoadFile);
            ...
            $.ajax({
                ...
                dataType: "json",
                error: function () {
                    alert(VIS.Msg.getMsg('ERRORGettingInitialData'));
        ...
        var createTenant = function () {
            ...
            if (currencyName == null || currencyName.length == 0 || currencyName.trim().length == 0) {
                alert(VIS.Msg.getMsg('FillCurrency'));
                return;
            }
            ...
            if (countryName == null || countryName.length == 0 || countryName.trim().length == 0) {
                alert(VIS.Msg.getMsg('FillCountry'));
                return;
            }
            ...
            if (regionName == null || regionName.length == 0 || regionName.trim().length == 0) {
                alert(VIS.Msg.getMsg('FillRegion'));
                return;
            }
            if (chkDA.prop('checked')) {
                fileName = null;
                ...
                if (fileName == null || fileName.length == 0 || fileName.trim().length == 0) {
                    alert(VIS.Msg.getMsg('SelectFile'));
                    return;
                }
            }
